...
public class UserHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `missa`.`users` WHERE `id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                u = new User(user_id, email, password, name);
    ...
    public JSONObject getByID(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`users` WHERE `id` = ? LIMIT 1";
    ...
    public boolean checkDuplicate(User u){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `missa`.`users` WHERE `email` = ?";
