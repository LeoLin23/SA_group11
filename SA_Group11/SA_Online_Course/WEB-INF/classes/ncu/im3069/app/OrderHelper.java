...
public class OrderHelper {
    ...
    public JSONObject create(Order order) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "INSERT INTO `missa`.`orders`(`username`, `create`)"
                    + " VALUES(?, ?)";
            ...
            if (rs.next()) {
                id = rs.getLong(1);
                ArrayList<OrderItem> list = order.getOrderCourse();
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                o = new Order(id, username, create);
